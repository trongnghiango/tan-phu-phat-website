...
const solutions = [
  ...
  { name: 'Security', description: "Your customers' data will be safe and secure.", href: '#', icon: HiOutlineShieldCheck },
  {
    name: 'Integrations',
...
const resources = [
  ...
  { name: 'Security', description: 'Understand how we take your privacy seriously.', href: '#', icon: HiOutlineShieldCheck },
]
const recentPosts = [
